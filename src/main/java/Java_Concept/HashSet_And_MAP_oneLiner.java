...
public class HashSet_And_MAP_oneLiner {
    /**
     ...
     Set Implementations :
     HashSet – Unordered, allows one null element, based on HashMap.
     LinkedHashSet – Maintains insertion order, allows one null element.
     TreeSet – Sorted order, no null element, based on TreeMap.
