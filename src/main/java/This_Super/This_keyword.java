...
public class This_keyword {
    ...
    private int age;
    // Constructor
    public This_keyword(String name) { // Use "this" to refer to the instance variable "name"
          this.name = name;
    }
    private This_keyword(int age){
        this.age = age;
    }
    public void getAge()  // Method to print the name of the person that is the instance variable value
    {
        System.out.println(this.age);
    }


    public void printName() { // Use "this" to refer to the instance variable "name"
